    ...
    var ZodString = class _ZodString extends ZodType {
      ...
      datetime(options) {
        ...
        return this._addCheck({
          ...
          ...errorUtil_js_1.errorUtil.errToObj(options == null ? void 0 : options.message)
        });
      }
      date(message) {
...
var require_dist = __commonJS({
  "../shared/dist/index.js"(exports) {
    ...
    exports.passwordSchema = zod_1.z.string().min(8, "Password must be at least 8 characters").regex(/[A-Z]/, "Must contain at least one uppercase letter").regex(/[0-9]/, "Must contain at least one number").regex(/[^A-Za-z0-9]/, "Must contain at least one special character");
    exports.registerRequestSchema = zod_1.z.object({
      ...
      phoneNumber: zod_1.z.string().regex(/^\+?[1-9]\d{1,14}$/, "Invalid phone number").optional().or(zod_1.z.literal("")),
      dob: zod_1.z.string().refine((val) => !isNaN(Date.parse(val)), "Invalid date format").refine((val) => new Date(val) < /* @__PURE__ */ new Date(), "Date of birth must be in the past"),
...
//# sourceMappingURL=@healthcare_shared.js.map
